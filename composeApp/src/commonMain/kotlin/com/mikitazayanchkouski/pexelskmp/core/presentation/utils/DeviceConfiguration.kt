...
fun currentDeviceConfiguration(): DeviceConfiguration {
    ...
    return DeviceConfiguration.convertFromWindowSizeClass(windowSizeClass = windowSizeClass)
}
...
enum class DeviceConfiguration {
    ...
    companion object {
        fun convertFromWindowSizeClass(windowSizeClass: WindowSizeClass): DeviceConfiguration {
